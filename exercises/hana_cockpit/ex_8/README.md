...
3. Click on a the **horizontal bar for one of the backups** to get details on memory consumed by complete data backup and other backup types. Notice the amount of memory occupied by Log and Catalog Backups. Click **Close** button to close the pop up.
