...
If you are a trial user and you've already created one instance, click [here](../ex7/README.md) to add an SAP HANA Cloud, Data Lake instance to your SAP HANA Cloud, SAP HANA Database instance before you proceed to the next exercise. 
